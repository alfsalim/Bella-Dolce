$root = "C:\Users\alfsa\Projects\personal\Bella-Dolce\PrintAgent\src\BellaDolce.PrintAgent"
$publish = "C:\Users\alfsa\Projects\personal\Bella-Dolce\PrintAgent\publish"
...
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
Write-Host "EXE location:  $publish\BellaDolce.PrintAgent.exe" -ForegroundColor Cyan
Write-Host ""
